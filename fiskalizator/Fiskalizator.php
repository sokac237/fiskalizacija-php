...
require_once('fiskalizator/Certificate.php');
require_once('fiskalizator/FiskalRequestXML.php');
require_once('fiskalizator/FiskalResponseXML.php');
require_once('fiskalizator/CIS_Service.php');
...
class Fiskalizator {
     ...
     */
    public function doRequest(DOMDocument $xmldoc, $attempts = 1, $timeout = 5) {
        ...
        //spremanje requesta kojeg saljem
